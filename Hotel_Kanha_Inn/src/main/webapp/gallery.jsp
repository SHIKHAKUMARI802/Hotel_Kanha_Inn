        ...
        <div class="roombox">
            ...
            <div class="box1">
                ...
                <div class="box"> 
                   <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRPs9zFiyd1WmLEUfsvkooFKTywfs5ihS-0nw&s" alt="imageBox1">                 
                    <div class="btn">
                        <div class="content"> <br>Single Room  <br>
                             Room Fare:1800 per day
                        <br>One single bed, Air conditioning,Television,24/7 
                        wifi access, Complimentary Breakfast Available , Private bathroom with toiletries, Room service.
                        </div>                      
                    </div>
                </div>
                <div class="box">               
                    ...
                    <div class="btn">
                    <div class="content"> <br> Twin Room  <br>
                        Room Fare:2500 per day
                    <br>Two single beds, Air conditioning,Televison, 24/7 wifi access,Complimentary Breakfast Available,  Private bathroom with toiletries, Room service.
                    </div>
                    </div>
                </div>
                <div class="box">
                    ...
                    <div class="btn">
                        <div class="content"><br>Double Room  <br>
                            Room Fare:3000 per day
                        <br>One double bed (for two guests), Air conditioning,Televison,24/7 wifi access,Mini fridge, Complimentary Breakfast Available,  Private bathroom with toiletries, Room service.
                        </div>
                       </div>
                </div>
            ...
            <div class="box2">
                ...
                <div class="box">
                    ...
                    <div class="btn">
                        <div class="content1"><br>Deluxe Room  <br>
                            Room Fare:6000 per day
                        <br>Spacious room with a king-size or queen-size bed,Air conditioning, Private bathroom with premium toiletries,
                        Television with premium channels,Mini fridge & coffee maker,  Work desk, Complimentary breakfast,Room service, City or garden view
            </div>
        </div>
   </div>
                ...
                <div class="box">
                    ...
                    <div class="btn">
                        <div class="content1"><br>Suite  Room  <br>
                            Room Fare:8000 per day
                        <br> Separate living area & bedroom,
                        King-size bed,
                        Free Wi-Fi,
                        Air conditioning,
                        Private bathroom with bathtub & luxury toiletries,
                        Large LED TV with premium channels,
                        Mini bar & coffee machine,
                        Work desk,
                        Complimentary breakfast & evening snacks,
                        24/7 Room service,
                        Balcony with a view (optional).
                        </div>
                       </div>
                </div>
                ...
                <div class="box">
                    ...
                    <div class="btn">
                        <div class="content1"><br>Business Class  <br>
                            Room Fare:10000 per day
                        <br>King-size bed or twin beds,
